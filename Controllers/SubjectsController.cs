...
namespace SchoolPortal.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        {
            var subjects = db.Subjects.Include(s => s.Student).Include(s => s.Year);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,PassMark,StudentId,YearId")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,PassMark,StudentId,YearId")] Subject subject)
        {
            if (ModelState.IsValid)
            {
